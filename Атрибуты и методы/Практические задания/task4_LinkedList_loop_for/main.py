...
class LinkedList:
    ...
    def init_linked_list(self, data: Iterable):
        ...
        self.len = len(self.list_nodes) #длинна списка
    ...
    def step_by_step_on_nodes(self, index: int) -> Node:
        ...
        if not 0 <= index < self.len:
            raise IndexError("Индекс вне границ")# TODO проверка корректности границ индекса
...
if __name__ == '__main__':
    ...
    for value in linked_list:
        print(value)# TODO с помощью цикла for распечатать в столбик все значения связного списка
