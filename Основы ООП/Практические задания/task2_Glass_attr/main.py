...
if __name__ == "__main__":
    ...
    glass2 = Glass(300,20)  # TODO инициализировать ещё один стакан
    ...
    glass2.occupied_volume += 100#  TODO доливаем воды в первый стакан
    print(glass1.capacity_volume, glass1.occupied_volume)
    print(glass2.capacity_volume, glass2.occupied_volume)
    print(glass1 is glass2)
    #print(glass1 == glass2)

    #def __el__(glass1, glass2):#  TODO сравнить id объектов
